...
class User_model extends MY_Model { 
	...
	public function getUserLists($status='',$limit, $start=0, $key){
		...
		$sql .= " GROUP BY member_master.member_id ORDER BY created_time DESC";
	...
	public function checkTodaysMeeting($member_id, $date)
	{
		...
		$sql = "SELECT vsl.log_id
				 ...
				 WHERE DATE_FORMAT(created_time,'%Y-%m-%d')= '$date' AND member_id = $member_id";
